...
def comparer_deux_balances(df_balance1, df_balance2, nom_balance1="Balance 1", nom_balance2="Balance 2"):
    ...
    df_compare = pd.merge(
        ...
        df_b2_agg[['Clé', 'ID_AGENCI', 'ID_ACCOUNT', 'Montant_B2']],
        on='Clé',
        how='outer',
        suffixes=('_B1', '_B2')
    )
    ...
    # Réorganiser les colonnes — deux colonnes ID_ACCOUNT distinctes pour la lisibilité
    df_compare = df_compare[[
        'ID_AGENCI', 'ID_ACCOUNT_B1', 'ID_ACCOUNT_B2',
